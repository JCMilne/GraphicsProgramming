...
void ShaderClass::InitaliseShader(const std::string& vertFile, const std::string& fragFile)
{
	...
	ErrorCheck(shaderProgram, GL_LINK_STATUS, true, "Error: Shader program linking failed"); // cheack for error
...
void ShaderClass::Update(const ModelTransform& transform, const SceneCamera& camera)
{
